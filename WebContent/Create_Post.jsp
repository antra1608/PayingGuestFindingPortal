    ...
    <div id="templatemo_menu_login_section">
    	<div id="templatemo_menu_section">
        	<div id="templatemo_menu_panel">
                <ul>
                    <li><a href="Bulletin_board.jsp" class="current">Back</a></li>
...
<div id="templatemo_content_panel_1">
   ...
   <table align="center" >
   <tr>
   <td><img src="images/category_services_icon.png"></img> </td>
   <td rowspan=><br /><table align="center" border=1>
   <form action="Savepost">
   <input type="hidden" name="category" value="createpost"/>
   <table>   <tbody>
   <tr><td><h1>Write your post here</h1></td></tr>
   <tr>
   <td>
   <textarea name="post" rows="10" clos="200"></textarea>
   </td>
   </tr>
   <tr><td>
   <input type="submit" name="submit" value="Post It"/></td></tr>
   </tbody>
   </table>
   </td>
   </tr>
