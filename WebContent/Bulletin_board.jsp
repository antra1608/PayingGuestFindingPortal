...
<body>
	<div id="templatemo_container">
		...
		<div id="templatemo_content_panel_1">
			<div id="templatemo_section_3_1" align=center>
				<table align="left">
					<tr>
						<td><img src="images/bulletinboard_bucket.png"></img></td>
						<td align="center"><br />
						<h1>&nbsp&nbsp&nbspBULLETIN BOARD</h1></td>
					</tr>
				</table>
				<br></br> <br></br>
				<table align="left" border=0>
					<tr>
						<td rowspan="2">POST Free ads to make your announcements loud
							and clear -<br /> Advertise services YOU provide, promote your PG</br> with DISCOUNTS and OFFERS
						</td>
						<form action="Create_Post.jsp">
						<td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input
							type="submit" value="Create Post"></input></td></form>
					</tr>
					<tr><form action="Savepost">
					<input type="hidden" name="category" value="mypost"/>
						<td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input
							type="submit" value="My Posts"></input></td></form>
					</tr>
				</table>
			</div>
			<!-- end of section 1 -->
		...
		<div id="templatemo_content_panel_3">
			...
			<div class="templatemo_section_3">
				<h1>Partner Links</h1>
				<ul class="list_section">
					<li><a href="#" target="_blank">Free
							Flash</a></li>
					<li><a href="#" target="_blank">Free
							CSS</a></li>
					<li><a href="#" target="_blank">Web
							Design</a></li>
					<li><a href="#" target="_blank">Free
							Photos</a></li>
				</ul>
