    ...
    <div id="templatemo_menu_login_section">
    	<div id="templatemo_menu_section">
        	<div id="templatemo_menu_panel">
                <ul>
                    <li><a href="Lodger_Dashboard3.jsp" class="current">Back</a></li>
                </ul> 
            </div> <!-- end of menu -->
        </div>
...
<h1 align="center">Resultant PG</h1>

<center>
<table border=1>

<% 
ArrayList<String> a = (ArrayList<String>)request.getAttribute("PG");
...
<td>
<a href=<%="\"Pg_dashboard_update?p_name="+a.get(i)+"&category="+"view_details"+"\"" %>>View Details</a>
</td></tr>
