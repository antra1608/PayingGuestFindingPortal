...
<div id="templatemo_content_panel_1">
    ...
    <h1>RESIDENTS INFORMATION</h1> for loop for each pg's resident info
<table align=center><th><td>Name of Lodger</td><td>Rent</td><td>Status(Pending/Recieved)</td><td>Send Mail For Payment</td></th></table>    
    </div>
    <!-- end of section 1 -->
</div>
